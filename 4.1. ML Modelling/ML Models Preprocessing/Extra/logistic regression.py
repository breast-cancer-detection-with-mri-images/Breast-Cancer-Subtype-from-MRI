...
def start():
    ...
    logreg_pr = LogisticRegression(max_iter = max_iter, random_state = SEED)
    ...
    logreg_her2 = LogisticRegression(max_iter = max_iter, random_state = SEED)
    ...
    logreg_mol_subtype = LogisticRegression(max_iter = max_iter, random_state = SEED)
