...
def start():
    ...
    svm_er = SVC(C = 1, kernel = 'rbf', degree = 3, gamma = 'auto', probability = True)
    ...
    svm_pr = SVC(C = 1, kernel = 'rbf', degree = 3, gamma = 'auto', probability = True)
    ...
    svm_her2 = SVC(C = 1, kernel = 'rbf', degree = 3, gamma = 'auto', probability = True)
    ...
    svm_mol_subtype = SVC(C = 2, kernel = 'poly', degree = 5, gamma = 'auto', probability = True)
